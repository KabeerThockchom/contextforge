...
class TestOpenAIProvider:
    ...
    async def test_generate_success(self, mock_session):
    ...
    @pytest.mark.asyncio
    @patch('aiohttp.ClientSession')
    async def test_generate_error(self, mock_session):
    ...
    @pytest.mark.asyncio
    @patch('aiohttp.ClientSession')
    async def test_generate_streaming(self, mock_session):
        ...
        mock_response.content = iter(stream_data)
        mock_session.return_value.__aenter__.return_value.post.return_value.__aenter__.return_value = mock_response
...
class TestAnthropicProvider:
    ...
    @pytest.mark.asyncio
    @patch('aiohttp.ClientSession')
    async def test_generate_with_system_message(self, mock_session):
